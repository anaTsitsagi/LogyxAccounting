...
public class DirectoriesMenuViewComponent : ViewComponent
{
    ...
    {
        var items = new[] {
            new Item { Text = "პროდუქტები",Url = Url.Page("/Products"), Key="products" },
            new Item { Text = "ანგარიშთა გეგმა", Url = Url.Page("/Accounts"), Key = "accounts" },
        ...
        activeKey ??= (RouteData.Values["Key"]?.ToString() ?? "").ToLower();
